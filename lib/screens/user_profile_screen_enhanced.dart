        ...
        background: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Color(0xFF6A5ACD), Color(0xFF8A7BE8)],
            ),
          ),
          child: Center(
            child: Column(
      ...
      child: Column(
        children: [
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.people, color: Color(0xFF6A5ACD)),
                SizedBox(width: 12),
                Text(
                  'Gender',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(icon, color: const Color(0xFF6A5ACD)),
              const SizedBox(width: 12),
              Text(
                title,
                style: const TextStyle(
      ...
      child: Column(
        children: [
          CircleAvatar(
            ...
            child: Icon(icon, color: const Color(0xFF6A5ACD)),
          ),
          const SizedBox(height: 8),
          Text(label),
        ],
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.logout, color: Color(0xFF6A5ACD)),
              SizedBox(width: 8),
              Text('Logout'),
            ],
          ),
