...
class _DashboardScreenState extends State<DashboardScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                if (_productInfo!['nutriments'] != null) ...[
                  ...
                  const SizedBox(height: 5),
                  Text('Energy: ${_productInfo!['nutriments']['energy-kcal_100g'] ?? 'N/A'} kcal'),
                  Text('Fat: ${_productInfo!['nutriments']['fat_100g'] ?? 'N/A'} g'),
                  Text('Carbohydrates: ${_productInfo!['nutriments']['carbohydrates_100g'] ?? 'N/A'} g'),
                  Text('Protein: ${_productInfo!['nutriments']['proteins_100g'] ?? 'N/A'} g'),
                  Text('Salt: ${_productInfo!['nutriments']['salt_100g'] ?? 'N/A'} g'),
                ],
              ],
            ),
          ),
  ...
  Widget _buildProfilePage() {
    ...
    descriptionController.text = SigninScreen.userData['user_description'] ?? '';
